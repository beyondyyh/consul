...
func TestFilter_NoKey(t *testing.T) {
	...
	events = append(events, newSimpleEvent("One", 102), Event{Key: "Two"})
...
func TestFilter_WithKey_AllEventsMatch(t *testing.T) {
	events := make(PayloadEvents, 0, 5)
	events = append(events, newSimpleEvent("Same", 103), newSimpleEvent("Same", 0))
...
func TestFilter_WithKey_SomeEventsMatch(t *testing.T) {
	...
	events = append(events, newSimpleEvent("Same", 104), newSimpleEvent("Other", 0), newSimpleEvent("Same", 0))
